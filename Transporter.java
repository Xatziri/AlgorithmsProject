...
* @param maximumAllocation the maximum number of units this transporter can be
allocated
* @param allocation the number of units initially allocated to this
transporter
*/
...
if (allocation <= maximumAllocation) {
this.allocation = allocation;
} else {
this.allocation = maximumAllocation;
}
}
/**
...
if (allocation > this.maxCapacity) {
this.allocation = this.maxCapacity;
} else {
this.allocation = allocation;
}
}
